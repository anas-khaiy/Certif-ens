...
import com.certiflow.formateur.service.PasswordResetService;
...
public class AuthenticationController {
    ...
    @PutMapping("/me")
    public ResponseEntity<Void> updateProfile(@RequestBody com.certiflow.formateur.dto.UpdateProfileRequest request) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String email = authentication.getName();
