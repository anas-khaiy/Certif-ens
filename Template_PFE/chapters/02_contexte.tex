...
La transformation numérique de l'éducation a révélé des lacunes critiques dans les outils de gestion de l'apprentissage (LMS) traditionnels :
\begin{itemize}
    \item \textbf{Fragmentation des outils :} Les institutions doivent souvent jongler entre plusieurs logiciels non compatibles pour la surveillance, les réunions et la gestion des cours.
    \item \textbf{Absence d'IA native :} La plupart des plateformes actuelles ne tirent pas profit de l'IA générative pour assister le formateur dans la conception pédagogique.
    \item \textbf{Vulnérabilité des examens :} Les évaluations à distance sont souvent perçues comme moins fiables faute de mécanismes de surveillance performants et intégrés.
\end{itemize}
L'absence d'une solution unifiant sécurité (Proctoring) et assistance (IA Générative) constitue le cœur de notre problématique.

\section{Objectifs du projet}
Les objectifs de CertifEns s'articulent autour de trois dimensions :
...
Pour assurer la flexibilité et la réactivité face aux défis techniques de l'IA, nous avons adopté la méthodologie \textbf{Scrum}. Ce cadre agile permet une livraison incrémentale des fonctionnalités et une adaptation continue aux besoins des utilisateurs finaux.
...
\begin{table}[H]
\centering
\caption{Équipe Scrum du projet CertifEns.}
...
La réalisation de CertifEns a été structurée en 11 sprints majeurs, permettant une gestion granulaire des complexités techniques de l'IA et des microservices.

\begin{table}[H]
\centering
\caption{Planification détaillée des sprints du projet CertifEns.}
\label{table:sprints}
