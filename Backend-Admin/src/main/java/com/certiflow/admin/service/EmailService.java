...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String toEmail, String prenom, String code) {
        try {
            ...
            helper.setSubject("🔐 ENS-Learning — Réinitialisation de votre mot de passe");
                                    ...
                                    <tr>
                                        <td style="padding:24px 40px;border-top:1px solid rgba(99,102,241,0.2);text-align:center;">
                                            <p style="color:#334155;font-size:12px;margin:0;letter-spacing:0.1em;text-transform:uppercase;font-weight:600;">
                                                © 2026 ENS-Learning — Tous droits réservés
                                            </p>
                                        </td>
                                    </tr>
                                </table>
    ...
    public void sendCoordinateurWelcomeEmail(String toEmail, String prenom, String password) {
        sendWelcomeEmail(toEmail, prenom, password, "Coordinateur");
    }
    ...
    private void sendWelcomeEmail(String toEmail, String prenom, String password, String roleName) {
        try {
            ...
            helper.setTo(toEmail);
            helper.setSubject("🎓 ENS-Learning — Bienvenue sur votre plateforme !");
            helper.setFrom("ENS-Learning <noreply@ens-marrakech.ac.ma>");
                        ...
                        <tr>
                            <td align="center">
                                <table width="560" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:32px 40px;text-align:center;">
                                            <h1 style="color:#fff;margin:0;font-size:26px;font-weight:800;letter-spacing:-0.5px;">🎓 ENS-Learning</h1>
                                    ...
                                    <tr>
                                        <td style="padding:40px;">
                                            ...
                                            <p style="color:#94a3b8;font-size:15px;margin:0 0 32px;line-height:1.6;">
                                                Votre compte <strong>%s</strong> a été créé avec succès sur <strong>ENS-Learning</strong>.
                                            </p>
                                            <div style="background:linear-gradient(135deg,rgba(99,102,241,0.15),rgba(139,92,246,0.15));
                                    ...
                                    <tr>
                                        <td style="padding:24px 40px;border-top:1px solid rgba(99,102,241,0.2);text-align:center;">
                                            <p style="color:#334155;font-size:12px;margin:0;letter-spacing:0.1em;text-transform:uppercase;font-weight:600;">© 2026 ENS-Learning — Tous droits réservés</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
