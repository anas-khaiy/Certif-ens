            ...
            try {
                const results = await Promise.all(
                    enrolledCourses.map(async (course) => {
                        try {
                            // Fetch both progress (sub-sections) and quiz results (for final exam)
                            ...
                            const quizResults = Array.isArray(resultsRes.data) ? resultsRes.data : []; // Ensure quizResults is an array
                            ...
                            // Filter to unique valid completed sub-sections
                            ...
                            // Include final exam if enabled and exists
        ...
        <div className="space-y-8 animate-fade-in pb-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-text-muted mt-2 font-medium">Vous êtes inscrit à <span className="text-primary font-bold">{filteredCourses.length} formations</span>. Continuez votre progression !</p>
                </div>
            </div>
