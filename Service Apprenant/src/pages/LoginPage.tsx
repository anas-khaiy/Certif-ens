...
const LoginPage = () => {
    ...
    const [viewState, setViewState] = useState<'LOGIN' | 'MFA' | 'RESET_EMAIL' | 'RESET_CODE' | 'RESET_PASSWORD'>('LOGIN');
    ...
    const handleMfaVerify = async (e: React.FormEvent) => {
        ...
        try {
            const response = await api.post('/auth/mfa/verify', { email, code: parseInt(mfaCode) });
            const data = response.data;
            loginSuccess(data);
        } catch (err: any) {
            ...
            >
                ...
                {error && (
                    <motion.div
                        initial={{ opacity: 0, y: -10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="mb-6 flex items-center gap-3 p-4 rounded-xl bg-error/10 border border-error/30 text-error"
                    >
                            ...
                            >
                                ...
                                <div className="relative input-focus-effect rounded-xl overflow-hidden transition-all duration-300">
                                    ...
                                    <input
                                        type="email"
                                        required
                                        placeholder="admin@certifens.com"
                    ...
                    <form onSubmit={handleMfaVerify} className="space-y-8">
                        <div className="space-y-6">
                            ...
                            >
                                ...
                                <p className="text-xs text-text-muted text-center mt-4 px-4 leading-relaxed">
                                    Entrez le code à 6 chiffres affiché dans votre application Google Authenticator.
                                </p>
                            </motion.div>
                        </div>
                        ...
                        <div className="flex flex-col gap-4">
                            <motion.button
                                ...
                                type="submit"
                                disabled={isLoading}
                                className="w-full h-14 primary flex items-center justify-center gap-3 text-lg font-bold rounded-xl shadow-xl transition-all duration-300 relative overflow-hidden group"
                            >
                                {isLoading ? (
                                    <div className="w-6 h-6 border-3 border-white/30 border-t-white rounded-full animate-spin relative z-10"></div>
                                ) : (
                            ...
                            <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="form-group">
                                ...
                                <div className="relative input-focus-effect rounded-xl overflow-hidden transition-all duration-300">
                                    ...
                                    <input
                                        ...
                                        className="form-input w-full h-14 bg-background/30 backdrop-blur-md border border-glass-border rounded-xl pl-14 pr-6 text-base focus:bg-background/50 transition-all outline-none text-text"
                            ...
                            <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="form-group">
                                ...
                                <div className="relative input-focus-effect rounded-xl overflow-hidden transition-all duration-300">
                                    ...
                                    <input
                                        ...
                                        className="form-input w-full h-14 bg-background/30 backdrop-blur-md border border-glass-border rounded-xl pl-14 pr-6 text-center text-2xl tracking-[0.5em] font-bold focus:bg-background/50 transition-all outline-none text-text"
                        ...
                        <div className="space-y-6">
                            <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="form-group">
                                ...
                                <div className="relative input-focus-effect rounded-xl overflow-hidden transition-all duration-300">
                                    ...
                                    <input type="password" required minLength={6} placeholder="••••••••" className="form-input w-full h-14 bg-background/30 backdrop-blur-md border border-glass-border rounded-xl pl-14 pr-6 text-base focus:bg-background/50 transition-all outline-none text-text" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                                </div>
                            </motion.div>
                            <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="form-group">
                                ...
                                <div className="relative input-focus-effect rounded-xl overflow-hidden transition-all duration-300">
                                    <div className="absolute left-[10px] top-0 bottom-0 w-12 flex items-center justify-center text-primary z-20"><Lock size={22} strokeWidth={3} /></div>
                                    <input type="password" required minLength={6} placeholder="••••••••" className="form-input w-full h-14 bg-background/30 backdrop-blur-md border border-glass-border rounded-xl pl-14 pr-6 text-base focus:bg-background/50 transition-all outline-none text-text" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                                </div>
                            </motion.div>
                        </div>
                        <div className="flex flex-col gap-4">
