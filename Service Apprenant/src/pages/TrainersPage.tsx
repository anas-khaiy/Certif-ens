    ...
    return (
        <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="pagination border-t border-glass-border bg-surface-hover/10 px-6 py-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex gap-1.5">
                                {getPages().map((page, i) => (
                                    page === '...' ? (
                                        <div key={`dots-${i}`} className="w-10 h-10 flex items-center justify-center text-text-muted font-bold select-none cursor-default">
                                            ...
                                        </div>
                                    ) : (
                                        <button
            ...
            <ConfirmationModal
                ...
                message="Voulez-vous vraiment supprimer ce formateur ? Cette action est irréversible."
